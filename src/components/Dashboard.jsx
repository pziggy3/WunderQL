...
const Dashboard = ({ url, urlID }) => {
  ...
  return (
    <div id="dashboard" style={themeStyle}>
      ...
      <div id="top-left">
        <div className="dashboard-stats">
          <div className="dash-title">
            <h3>Total Unique Queries</h3>
          </div>
          <div className="dash-num">
            <h1>{totalUniqueQueries}</h1>
          </div>
        </div>
      </div>
      <div id="top-mid">
      ...
      <div id="bottom-right">
        <PieChartComponent
          totalLoadTestSuccesses={totalLoadTestSuccesses}
          totalLoadTestFailures={totalLoadTestFailures}
        />
      </div>
    </div>
  );
